/**
 * Real Estate Sales Chart (Chart.js)
...
const salesData = {
    ...
    sales: [85, 92, 78, 110, 125, 147],
    listings: [120, 135, 128, 145, 160, 175],
};
...
export function initRealEstateChart(staggerOffset = 0) {
    if (chartInstance) {
    ...
    initChartJsDeferred('real-estate-chart', (container) => {
